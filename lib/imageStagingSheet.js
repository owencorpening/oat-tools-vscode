...
const COL = { name: 1, url: 2, photographer: 3, license: 4, attribution: 6, status: 7, placed_in: 8, placed_date: 9, target: 10, imageSrc: 11 };
...
async function getAllRows(sheetId, token) {
  ...
  try {
    ...
    throw new Error(`OAT: sheet fetch failed: ${e.message}`);
  }
